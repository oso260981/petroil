view: usuario_petroil {
  derived_table: {
    sql: SELECT id_Cliente,nb_cliente,case when id_Cliente between 1 and 40 then 'maria.granados@grupo-eon.com'
                                  ...
                                  when id_Cliente between 101 and 500 then 'luis.hernandez@grupo-eon.com' end usuario FROM `sipp-app.Tableros.Vis_Ventas` group by id_Cliente,nb_cliente order by id_cliente LIMIT 100
 ;;
  }
